...
window.addEventListener('keydown',e=>{
 ...
 if(e.key.toLowerCase()==='r'&&typeof start==='function'&&typeof g!=='undefined'&&g){if(window.magnetChallengeActive?.level===g.n)window.magnetChallengeRun=(window.magnetChallengeRun||0)+1;start(g.n||1)}
