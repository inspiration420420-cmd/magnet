const CACHE='magnet-mayhem-v4';
const ASSETS=['./','./index.html','./style.css','./game2.js','./systems.js','./mobile-enhancements.js','./boss-system.js','./challenge-system.js','./accessibility-controls.js','./gameplay-overdrive.js','./polish-system.js','./level-select.js','./manifest.json','./icon.svg'];
