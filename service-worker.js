const CACHE='magnet-mayhem-v2';
const ASSETS=['./','./index.html','./style.css','./game2.js','./systems.js','./mobile-enhancements.js','./boss-system.js','./challenge-system.js','./accessibility-controls.js','./gameplay-overdrive.js','./polish-system.js','./manifest.json','./icon.svg'];
